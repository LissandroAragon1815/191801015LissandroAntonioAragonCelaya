 ...
 * @author ntnrc
 */
public class EstatusClientes extends javax.swing.JFrame {
    ...
    /**
     * Creates new form EstatusClientes
     */
    ...
    private void initComponents() {
        ...
        jPanel3.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 30, 330, 180));
    ...
    public static void main(String args[]) {
        ...
        {
            java.util.logging.Logger.getLogger(EstatusClientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EstatusClientes().setVisible(true);
            }
        });
    }
